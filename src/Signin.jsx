...
const Signin = () => {
  return (
    <div className='p-5 box flex flex-wrap bg-transparent justify-center item-center'>
        <img src={Ime}  className='absolute justify-center w-screen h-screen'></img>
     <div className='main mt-20 flex flex-wrap bg-slate-400 h-screen w-84 ring ring-slate-900 ring-offset-2'>
     
        </div>
     <form className='flex-col text-center mt-20'>
     <h1 className='text-white bg-transparent text-4xl mb-3 m-15 mt-20 text-center font-bold italic'>Dummy Form</h1>
        <p className='text-center text-slate-900 font-bold'>Welcome back! john Doe</p>   
            ...
            <button className="bg-transparent hover:bg-slate-900 text-black-900 font-bold hover:text-white py-2 px-4 border border-slate-900 hover:border-transparent rounded">
  Login
</button>
            </div>
        </form>
